...
bool DL_Dxf::readDxfGroups(FILE *fp, DL_CreationInterface* creationInterface) {
    ...
    if (DL_Dxf::getStrippedLine(groupCodeTmp, DL_DXF_MAXLINE, fp) &&
		...
		if (line < 400)
		{
			std::cout << "--CODE : " << groupCode << std::endl;
			std::cout << "--VALUE: " << groupValue << std::endl;
		}
...
bool DL_Dxf::processDXFGroup(DL_CreationInterface* creationInterface,
    ...
    // Indicates start of new entity or variable:
        ...
        case DL_SETTING:
			std::cout << "Adding setting..." << std::endl;
        ...
        case DL_LINETYPE:
			std::cout << "Adding linetype..." << std::endl;
        ...
        case DL_ENTITY_SPLINE:
			std::cout << "Adding spline..." << std::endl;
        ...
        case DL_ENTITY_ARCALIGNEDTEXT:
			std::cout << "Adding arc aligned text..." << std::endl;
        ...
        case DL_ENTITY_LEADER:
			std::cout << "Adding leader..." << std::endl;
        ...
        case DL_ENTITY_SEQEND:
			std::cout << "Ending sequence..." << std::endl;
		...
		std::cout << "Ending section..." << std::endl;
